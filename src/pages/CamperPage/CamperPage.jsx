...
const CamperPage = () => {
  ...
  if (!selectedCamper) return null;
    ...
    const { name, price, rating, location, gallery, description, reviews, transmission, engine, AC, bathroom, kitchen, TV, radio, refrigerator  } = selectedCamper;
      ...
      <div className={css.imageWrapper}>
        ...
        <div className={css.camperInfo}>
          ...
          <NavLink className={({ isActive }) =>
            isActive ? `${css.navigationItem} ${css.active}` : css.navigationItem} to="features">Features</NavLink>
          <NavLink  className={({ isActive }) =>
            isActive ? `${css.navigationItem} ${css.active}` : css.navigationItem} to="reviews">Reviews</NavLink>
            </nav>
